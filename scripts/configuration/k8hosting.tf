...
# ── EKS Namespace Map ─────────────────────────────────────────────────────────
# Flattened namespace definitions extracted from eks_clusters.
# Used by namespace module to create Kubernetes namespaces per cluster.
# Sourced from k8surface.yml component.cluster[].namespace[].
